db.RACE_LOGS.find({"RACE_LOG_EVENT.RACE_LOG_EVENT_CLASS": "RaceLogDeviceMarkMappingEvent"}).forEach(function(e) {
	if (e!= null){
		...
		var correspondingRegattaLogEvent = {    
   			...
   			"REGATTA_LOG_EVENT":{  
      			...
      			"REGATTA_LOG_EVENT_CLASS":"RegattaLogDeviceMarkMappingEvent",
   				"DEVICE_ID":{  
	      		...
	      		"MARK":{  
	        		"MARK_ID":e.RACE_LOG_EVENT.MARK.MARK_ID,
	         		"MARK_COLOR":e.RACE_LOG_EVENT.MARK.MARK_COLOR,
	         		"MARK_NAME":e.RACE_LOG_EVENT.MARK.MARK_NAME,
	         		"MARK_PATTERN":e.RACE_LOG_EVENT.MARK.MARK_PATTERN,
	         		"MARK_SHAPE":e.RACE_LOG_EVENT.MARK.MARK_SHAPE,
	         		"MARK_TYPE":e.RACE_LOG_EVENT.MARK.MARK_TYPE
	      		}
			},
